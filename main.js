(function($){
/*-
	q- when deleting any image the next image if any in the <li> take place of deleted image
	a- done

	q- if all images deleted then it print there is not image to del
	a- done

	q- animate when taking place of that image
	a- done

	q- after del next image and all other image should also take one prev step
	a- done

	q- at a time only one image can be deleted
	a- done
...
/*----
	...
	- on click remove list image
	- after no image text alert
